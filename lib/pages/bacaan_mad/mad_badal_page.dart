...
class MadBadalPage extends StatefulWidget {
  const MadBadalPage({super.key});

  @override
  State<MadBadalPage> createState() => _MadBadalPageState();
}

class _MadBadalPageState extends State<MadBadalPage> {
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Badal artinya perubahan. Hukum bacaan Mad Badal ialah apabila ada Hamzah bertemu dengan huruf huruf Mad.',
                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            if (isPlayed) {
                              await player.play(
                                AssetSource(
                                  'audios/bacaan_mad/mad_badal.mp3',
                                ),
                              );
                            }
